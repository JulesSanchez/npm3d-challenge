...
if __name__ == '__main__':
    ...
    for k in range(len(data_cross_val)):
        ...
        new_train_cloud1, new_train_label1 = get_even_number(train_cloud1,train_label1)
        new_train_cloud2, new_train_label2 = get_even_number(train_cloud2,train_label2)
